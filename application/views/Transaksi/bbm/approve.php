<div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Approve & Realisasi Bbm</h2>
                          ...
                          <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <?php 
                                        if ( $row->realisasi  == 1) { ?>
                                           <a href="" class=" tes" data="<?= $row->nota ?>" id="$row->nama"><i class="fa fa-check-circle btn btn-success"></i> </a><?php 
                                        }else { ?>
                                        
                                             <a data-toggle="modal" class=" tess" id="tess" data-modal="<?= $row->nota ?>" id="$row->nama"><i class="fa fa-minus-circle btn btn-danger"></i> </a><?php 
                                        } ?>
                                  </td>
                                  <td>
                                      <?php 
                                        if ( $row->acc  == 1) { ?>
                                           <a href="#" class=" off" data="<?= $row->nota ?>" id="$row->nama"><i class="fa fa-check-circle btn btn-success"></i> </a><?php 
                                        } else { ?>
                                             <a href="" class=" on" data="<?= $row->nota ?>" id="$row->nama"><i class="fa fa-minus-circle btn btn-danger"></i> </a><?php 
                                        } ?>
                                  </td>
                                  <td><?= $row->acc_by ?></td>
                                  <td><?= $row->insert_by ?></td>                                  
    ...
    $('.tess').on('click',function(){
        ...
        var a = btoa(id);
        // document.cookie=a;
        window.location.href = "<?= site_url('BBM/realisasi/') ?>" + a;
    });
</script>
   
    
      <!-- Modal Tambah -->
 <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="tambah-data" class="tes modal fade">
         ...
         <div class="modal-content">
             ...
             <div class="modal-header">
              ...
              <div class="modal-body">
                <form oninput="nominal.value = parseInt(harga.value) * parseInt(liter.value)" class="form-horizontal" action="" method="post">
